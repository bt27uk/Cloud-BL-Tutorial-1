...
%I thought this was the case, but using the default firewall, I got an error saying that the ssh port wasn't open
%may have to change instrux here if this turns out to be the case, and not something dumb I have done with my own setup.
